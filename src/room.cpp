...
void Room::setInnard(Innards *innard) { this->innard = innard; }

Innards *Room::getInnard() const { return &*innard; }

bool Room::hasKraken() const { return innard->getSymbol() == '#'; }
...
bool Room::isEdge() const { return !(north && south && east && west); }

Room::~Room() { delete innard; }